/**
* @Author: MillerD
* @Date:   2016-11-17T15:17:49+08:00
* @Email:  zlw2579@gmail.com
* @Last modified by:   MillerD
* @Last modified time: 2016-11-17T17:07:07+08:00
*/
...
, render: function() {
    ...
    styleSwipeoutBtn.push([{
      height: btn.height,
      width: btn.isDefine?btn.everyWidth:btn.width,
    }])
    ...
    return  (
      <TouchableHighlight
        ...
        style={[styles.swipeoutBtnTouchable,btn.isDefine?{flex:1.5}:{}]}
...
, _handlePanResponderGrant: function(e: Object, gestureState: Object) {
    ...
    this.refs.swipeoutContent.measure((ox, oy, width, height) => {
      this.setState({
        btnsLeftWidth: this.props.left ? this.state.btnWidth*this.props.left.length : 0,
        btnsRightWidth: this.props.right ? this.state.btnWidth*this.props.right.length : 0,
        swiping: ((this.props.right && this.props.right.length > 0) || (this.props.left && this.props.left.length > 0)) ? true : false,
    ...
    _renderButton: function(btn, i) {
      return (
        <SwipeoutBtn
            ...
            isDefine={btn.isDefine}
            everyWidth={btn.width}
